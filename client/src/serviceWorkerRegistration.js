...
// ne verront les mises à jour déployées qu'à la visite suivante de la page, après que toutes les onglets
  ...
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        // Ajoutez des journaux supplémentaires pour localhost, dirigeant les développeurs vers la
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              // veuillez actualiser."
              console.log('Nouveau contenu disponible et mis en cache.');

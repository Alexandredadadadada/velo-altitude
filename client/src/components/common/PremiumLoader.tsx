...
/**
 * Types de couleurs disponibles pour le loader
 * @typedef {'gradient' | 'blue' | 'pink' | 'white'} LoaderColorType
 */
type LoaderColorType = 'gradient' | 'blue' | 'pink' | 'white';

/**
 * Types d'animations disponibles pour le loader
 * @typedef {'spinner' | 'pulse' | 'dots'} LoaderType
 */
type LoaderType = 'spinner' | 'pulse' | 'dots';

/**
 * Props pour le composant PremiumLoader

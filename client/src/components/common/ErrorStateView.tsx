...
/**
 * Props pour le composant ErrorStateView
 ...
 * Utilisé dans toute l'application pour standardiser l'affichage des erreurs
 * et offrir une expérience utilisateur cohérente.
 * 
 * @example
 * ```tsx
 * <ErrorStateView 

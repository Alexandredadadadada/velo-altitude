...
/**
 * Props pour le composant EmptyStateView
 ...
 * Utilisé lorsque des données sont attendues mais aucune n'est disponible
 * (listes vides, résultats de recherche sans correspondance, etc.).
 * 
 * @example
 * ```tsx
 * <EmptyStateView 
 *   title="Aucun entraînement trouvé"
 *   message="Modifiez vos critères de recherche pour trouver des entraînements correspondants"

...
- Vérification de la propreté du code avant chaque déploiement.
- Suppression des scripts inutiles dans la checklist.
- Ajout de la vérification lint comme étape obligatoire.

**À surveiller** :
- Toujours valider la checklist après chaque refactor ou nettoyage de code.

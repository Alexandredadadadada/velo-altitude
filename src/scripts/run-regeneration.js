...
const { ColRegenerationService } = require('../services/col/ColRegenerationService');
const { ColRepository } = require('../services/col/ColRepository');
...
async function runRegeneration() {
  ...
  try {
    ...
    const results = await regenerationService.regenerateAll(options);

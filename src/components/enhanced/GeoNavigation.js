...
const GeoNavigation = ({ 
      ...
      <script type="application/ld+json">
        {
          ...
          "url": "https://velo-altitude.com/geonavigation"
        }
      </script>
      <EnhancedMetaTags
        title=""
  ...
  const renderRegionsView = () => {
    ...
    return (
      <main className="geo-regions-container">
  ...
  const renderDepartmentsView = () => {
    ...
    return (
      <main className="geo-departments-container">
  ...
  return (
    <div className="geo-navigation">
      <div className="geo-navigation-controls">
        ...
        <main className="geo-search-container">
      ...
      <article className="geo-navigation-content">

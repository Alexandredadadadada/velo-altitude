...
const EnhancedColDetail = () => {
  ...
  if (loading) {
    return <main className="loading-container">Chargement des données du col...</div>;
  }

  if (!colData) {
    return <main className="error-container">Col introuvable</div>;
  }
      ...
      <script type="application/ld+json">
        {
          ...
          "url": "https://velo-altitude.com/enhancedcoldetail"
        }
      </script>
